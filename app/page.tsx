// app/page.tsx (Updated with perPage support and data mapping)
...
import type { Product, Category, Blog, Testimonial } from "@/lib/types";
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        // url: "https://www.carshop.example/next.svg",
        width: 1200,
        height: 630,
        alt: "CarShop",
      },
  ...
  twitter: {
    ...
    title: "CarShop — Modern Car Store",
    description: "Discover premium cars with transparent pricing, expert insights, and a modern shopping experience.",
    // images: ["https://www.carshop.example/next.svg"],
  },
  robots: "index, follow",
...
export default async function Home() {
  const [productsResp, categoriesResp, blogsResp, testimonialsResp] = await Promise.all([
    fetchProducts({ page: 1, perPage: 6 }),
    fetchCategories(),
    fetchBlogs({ page: 1, perPage: 4 }),
