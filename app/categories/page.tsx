  ...
  return (
    <main className="bg-background text-foreground dark:bg-backgroundDark dark:text-foregroundDark">
      <Container className="py-12 sm:py-16 lg:py-20">
        <SectionHeader title="Browse by Category" subtitle="Explore vehicles by type and purpose." />
          ...
          {data.map((c: Category) => (
            ...
            >
              <div className="absolute inset-0 -z-10">
                {c.image ? (
                  <Image src={c.image} alt="" fill className="object-cover opacity-10 transition group-hover:opacity-20" unoptimized />
                ) : (
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <Link
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-secondary-500 text-white shadow-sm"
                >
                  →
                </Link>
              </div>
